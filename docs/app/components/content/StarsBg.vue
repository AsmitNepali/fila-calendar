...
<template>
  <div class="absolute pointer-events-none z-[-1] inset-y-0 inset-x-0 overflow-hidden">
    <svg
    ...
    <div
      class="stars size-full absolute inset-x-0 top-0"
      :class="cover === 'full' ? 'stars-full' : 'stars-band'"
    >
      <div
...
.stars-full {
  -webkit-mask-image: radial-gradient(ellipse 90% 85% at 50% 45%, #000 20%, transparent 100%);
